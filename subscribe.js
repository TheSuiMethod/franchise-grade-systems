...
export default async function handler(req, res) {
    ...
    //   KIT_TAG_SCORECARD           -> triggers Scorecard Nurture (Seg 1)
    //   KIT_TAG_CALCULATOR          -> triggers Calculator Nurture (Seg 1)
    //   KIT_TAG_QUIZ                -> triggers Quiz Nurture (Seg 1)
    //   KIT_TAG_LEAD_MAGNET         -> triggers Red Flags Guide sequence (Seg 1)
    //   KIT_TAG_ENGINE_INTEREST     -> triggers Decision Engine interest nurture (Seg 1)
    //   KIT_TAG_GAP_INTEREST        -> triggers Gap Analyzer interest nurture (Seg 2/3)
    //   KIT_TAG_PLAYBOOK_INTEREST   -> triggers Systems Playbook interest nurture (Seg 2/3)
    //   KIT_TAG_SPRINT_INTEREST     -> triggers Implementation Sprint interest nurture (Seg 2/3)
    //
    const TAG_MAP = {
        // Seg 1 - Lead gen tools
        ...
        // Seg 2/3 - Independent systems / operations products
        'gap-analyzer':            process.env.KIT_TAG_GAP_INTEREST || '',
        'operations-gap-analyzer': process.env.KIT_TAG_GAP_INTEREST || '',
